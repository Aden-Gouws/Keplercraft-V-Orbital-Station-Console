...
namespace Keplercraft_V_Orbital_Station_Console
{
    public class ModuleManager
    {
        ...
        private readonly StationLogger _logger = new StationLogger();
        ...
        public void AddModule(StationModule module)
        {
            ...
            module.ModuleStatusChanged += _logger.LogModuleStatus;
            module.CriticalConditionReached += _logger.LogCriticalCondition;
        }
